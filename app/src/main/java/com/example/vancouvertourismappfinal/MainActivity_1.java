...
public class MainActivity_1 extends AppCompatActivity {
    ...
    private void addAllItems()
    {
      ...
      allItemsList.add(FirebaseAuth.getInstance().getCurrentUser().getEmail());
      ...
      //  allDesc.add("Check out famous tourist spots");
       ...
       allDesc.add("Rate app, Share app,Contact us, Log Out");
       ...
       miscDesc.add("Rate app, Share app,Contact us, Log Out");
            ...
            public void onClick(View view, int position) {
                ...
                }else if(myTableLayout.getSelectedTabPosition()==3)
                {
                    switch(position)
                    {
                        ...
                        case 4:
                        {
                            Intent i=new Intent(MainActivity_1.this, Settings.class);
                            startActivity(i);
                ...
                }else if(myTableLayout.getSelectedTabPosition()==0)
                {
                    switch(position)
                    {
                        case 0:
                        {
                                Snackbar snackbar = Snackbar.make(view, "Welcome to Travapp ,"+allItemsList.get(0),Snackbar.LENGTH_LONG);
